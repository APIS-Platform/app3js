...
var packages = [{
    fileName: 'app3js',
    expose: 'App3',
    src: './packages/app3js/src/index.js',
    ignore: ['xmlhttprequest', 'websocket']
}, {
    fileName: 'app3-utils',
    expose: 'App3Utils',
    src: './packages/app3-utils/src/index.js'
}, {
    fileName: 'app3-apis',
    expose: 'App3Apis',
    src: './packages/app3-apis/src/index.js'
}, {
    fileName: 'app3-apis-accounts',
    expose: 'App3ApisAccounts',
    src: './packages/app3-apis-accounts/src/index.js'
}, {
    fileName: 'app3-apis-contract',
    expose: 'App3ApisContract',
    src: './packages/app3-apis-contract/src/index.js'
}, {
    fileName: 'app3-apis-personal',
    expose: 'App3ApisPersonal',
    src: './packages/app3-apis-personal/src/index.js'
}, {
    fileName: 'app3-apis-abi',
    expose: 'App3ApisAbi',
    src: './packages/app3-apis-abi/src/index.js'
}, {
    fileName: 'app3-net',
    expose: 'App3Net',
    src: './packages/app3-net/src/index.js'
}, {
    fileName: 'app3-providers-ws',
    expose: 'App3WsProvider',
    src: './packages/app3-providers-ws/src/index.js',
    ignore: ['websocket']
}, {
    fileName: 'app3-core-subscriptions',
    expose: 'App3Subscriptions',
    src: './packages/app3-core-subscriptions/src/index.js'
}, {
    fileName: 'app3-core-requestmanager',
    expose: 'App3RequestManager',
    src: './packages/app3-core-requestmanager/src/index.js'
}, {
    fileName: 'app3-core-promievent',
    expose: 'App3PromiEvent',
    src: './packages/app3-core-promievent/src/index.js'
}, {
    fileName: 'app3-core-method',
    expose: 'App3Method',
    src: './packages/app3-core-method/src/index.js'
}];
...
packages.forEach(function (pckg, i) {
    ...
    gulp.task(pckg.fileName, gulp.series(prevPckg, function () {
        ...
        console.log("expose : " + pckg.expose);
        console.log("src : " + pckg.src);
...
gulp.task('watch', function () {
    gulp.watch(['./packages/app3js/src/*.js'], gulp.series('lint', 'default'));
});
