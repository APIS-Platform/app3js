...
var promiEvent = require('app3-core-promievent');
...
Method.prototype._confirmTransaction = function (defer, result, payload) {
    ...
    var _apisCall = {};
    _.each(_apisCalls, function (mthd) {
        mthd.attachToObject(_apisCall);
    ...
    var checkConfirmation = function (existingReceipt, isPolling, err, blockHeader, sub) {
        ...
        if (!err) {
            ...
            return (existingReceipt ? promiEvent.resolve(existingReceipt) : _apisCall.getTransactionReceipt(result))
            ...
            .then(function(receipt) {
                ...
                if (isContractDeployment && !promiseResolved) {
                    ...
                    _apisCall.getCode(receipt.contractAddress, function (e, code) {
    ...
    var startWatching = function(existingReceipt) {
        ...
        if (_.isFunction(this.requestManager.provider.on)) {
            _apisCall.subscribe('newBlockHeaders', checkConfirmation.bind(null, existingReceipt, false));
        } else {
    ...
    _apisCall.getTransactionReceipt(result)
    .then(function(receipt) {
        if (receipt && receipt.blockHash) {
            if (defer.eventEmitter.listeners('confirmation').length > 0) {
...
Method.prototype.buildCall = function() {
    var method = this,
        isSendTx = (method.call === 'apis_sendTransaction' || method.call === 'apis_sendRawTransaction'); // || method.call === 'personal_sendTransaction'
    ...
    var send = function () {
        ...
        var sendRequest = function(payload, method) {
            ...
            if (method && method.accounts && method.accounts.wallet && method.accounts.wallet.length) {
                ...
                // ETH_SENDTRANSACTION
                if (payload.method === 'apis_sendTransaction') {
                    ...
                    // ETH_SIGN
                } else if (payload.method === 'apis_sign') {
