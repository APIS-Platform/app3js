...
Accounts.prototype.signTransaction = function signTransaction(tx, privateKey, callback) {
    ...
    return Promise.all([
        ...
        return signed(_.extend(tx, {chainId: args[0], gasPrice: args[1], gas: args[2], nonce: args[3]}));
    });
};


Accounts.prototype.authTransaction = function authTransaction(tx, knowledgeKey, callback) {
    var _this = this,
        error = false,
        result;
